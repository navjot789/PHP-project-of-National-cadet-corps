            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title"> Rejected Enrollment Requests</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                        ...
                        <tr>
                         ...
                         <td class="td-actions text-right">
                            <a href="dashboard.php?page=7&sub_page=0007&cadetid=<?php echo $jsons['cid'];?>" class="btn btn-info" >
                             ...
                             <a  href="sql/delete.php?del_r_enroll=<?php echo $jsons['fid'];?>&return_url=<?php echo $_GET['page'];?>" onclick="return confirm('Are you sure you want to delete this EnrollmentID?');" rel="tooltip" class="btn btn-danger">
