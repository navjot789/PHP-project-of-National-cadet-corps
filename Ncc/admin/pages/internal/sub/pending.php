                      ...
                      ?> 
                        ...
                        <tr>
                         ...
                         <td class="td-actions text-right">
                            ...
                            <a  href="sql/delete.php?del_p_enroll=<?php echo $jsons['fid'];?>&return_url=<?php echo $_GET['page'];?>" onclick="return confirm('Are you sure you want to delete this EnrollmentID?');" rel="tooltip" class="btn btn-danger">
